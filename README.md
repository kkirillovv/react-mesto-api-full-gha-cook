...
** Создать папку, зайти туда и склонировать репозиторий `git clone https://github.com/kkirillovv/react-mesto-api-full-gha`

** Установить все зависимости через `yarn или npm install`

** Запустить сперва back-end, а затем front-end через `yarn или npm start`
